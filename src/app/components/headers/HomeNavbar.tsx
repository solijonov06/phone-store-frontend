import { Box, Button, Container,
    ListItemIcon, Menu, MenuItem, Stack } from "@mui/material";
...
export default function HomeNavbar(props: HomeNavbarProps) {
   const {cartItems,onAdd,onDelete,onDeleteAll,handleCloseLogout,
      onRemove,setSignupOpen,
      handleLogoutRequest,setLoginOpen,anchorEl,handleLogoutClick,}= props;
